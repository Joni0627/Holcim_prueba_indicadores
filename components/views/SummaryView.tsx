...
export const SummaryView: React.FC<{ 
  ...
  const byMachine = useMemo(() => {
    ...
    const stats: Record<string, { bags: number, tn: number, availSum: number, perfSum: number, count: number, machineId: string, machineName: string, shiftMaxes: Record<string, number> }> = {
      'MG.672-PZ1': { bags: 0, tn: 0, availSum: 0, perfSum: 0, count: 0, machineId: 'MG.672-PZ1', machineName: 'MG.672-PZ1', shiftMaxes: {} },
      'MG.673-PZ1': { bags: 0, tn: 0, availSum: 0, perfSum: 0, count: 0, machineId: 'MG.673-PZ1', machineName: 'MG.673-PZ1', shiftMaxes: {} },
      'MG.674-PZ1': { bags: 0, tn: 0, availSum: 0, perfSum: 0, count: 0, machineId: 'MG.674-PZ1', machineName: 'MG.674-PZ1', shiftMaxes: {} }
    };
    ...
    unifiedDetails.forEach(d => {
      ...
      if (!key) {
        stats[d.machineId] = { bags: 0, tn: 0, availSum: 0, perfSum: 0, count: 0, machineId: d.machineId, machineName: d.machineName, shiftMaxes: {} };
        key = d.machineId;
      }
      ...
      const shiftDateKey = `${d.shift}|${d.dateISO}`;
