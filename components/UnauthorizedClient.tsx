        ...
        <div className="pt-4 flex flex-col items-center gap-6">
          ...
          <div className="w-full">
            <SignOutButton redirectUrl="/sign-in">
              <button className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-4 rounded-2xl transition-all flex items-center justify-center gap-2 shadow-[0_0_20px_rgba(16,185,129,0.2)] font-sans">
                <LogOut size={18} />
